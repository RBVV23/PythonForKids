...
# Вычислить максимальную и минимальную длину чашелистника (sepal_length) у растений вида setosa (после факторизации 0), у которых длина чашелистника (sepal_width) находится в пределах между 3 и 4 (то есть больше или равна 3 и при этом меньше или равна 4)
