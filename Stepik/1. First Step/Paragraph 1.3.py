...
a = int(input())
b = int(input())
print(a+b)  # допишите программный код...
...
# данную задачу можно решить без использования модуля math (см. примеры на предыдущих шагах)

a = int(input())
b = int(input())

print((a**2 + b**2)**0.5)  # допишите программный код